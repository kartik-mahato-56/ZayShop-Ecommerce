            ...
            <div class="row">
                ...
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        ...
                        <img class="card-img img-fluid" src="{{asset('Gallery/'.getSingleImage($product->images))}}" alt="Card image cap" id="product-detail">
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="{{asset('Gallery/'.$image)}}" alt="Product Image 1">
                                            </a>
                                        </div>
                                        @endforeach
                                        {{-- <div class="col-4">
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2"><b>{{$product->name}}</b></h1>
